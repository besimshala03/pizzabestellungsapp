...
import 'delete_getraenke_by_id_test.mocks.dart'; // This will be generated by mockito

@GenerateMocks([http.Client])
void main() {
  group('deleteGetraenkeById', () {
    ...
    test('returns success message if the http call completes successfully', () async {
      final int getraenkeId = 1;
      final url = Uri.parse('http://127.0.0.1:8080/getraenke/$getraenkeId');
      ...
      // Call the method
      final result = await backend.deleteGetraenkeById(mockClient, getraenkeId);

      // Verify the method returns the expected result
      expect(result, "Getränk erfolgreich gelöscht");
    });
    ...
    test('throws an exception if the http call completes with an error', () async {
      ...
      expect(
        () async => await backend.deleteGetraenkeById(mockClient, getraenkeId),
